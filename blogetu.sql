...
(2, 2, 2, 'Super article, merci !', '2026-05-24 00:13:09');
...
(2, 'Mon premier article', 'Ceci est le contenu de mon premier article sur ce blog', 2, '2026-05-24 00:12:28', '2026-05-24 00:12:28');
...
(2, 'john_doe', 'john@example.com', 'le_hash_du_mot_de_passe', 'user', '2026-05-24 00:11:18');
...
--
ALTER TABLE `likes`
  ADD CONSTRAINT `fk_post_id_likes` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_user_id_likes` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
